...
Now that we have our new data, we need to compare to the observed data.

7. Create a boxplot showing the distribution of anxiety for each musician in the simulated data.

8. Fit the random intercepts model (from exercise 2) with the *simulated* data, and report the estimated intra-class correlation.

9. Compare exercises 7 and 8 to exercises 1, 2, and 3. Does your simulation support the hypothesis that there are systematic differences in anxiety between musicians?