...
So far, we've seen probabilities, $\pi$, and odds, $\dfrac{\pi}{1 - \pi}$. Another way of looking at a categorical response is with the *log odds*, $\log \left( \dfrac{\pi}{1 - \pi} \right)$.
