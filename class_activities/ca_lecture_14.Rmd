---
title: "Class Activity, February 21"
output: 
  tufte::tufte_html:
    css: "lab.css"
...
We ave data on $n = 79$ Kentucky Derby races. Let $Y$ = condition, meaning the condition of race trace for each race, where the choices for track condition are fast, good, and slow. We want to explore the relationship between $X$ = winning speed (Speed) and $Y$ = track condition (Condition)
