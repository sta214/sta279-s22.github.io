...
| $\widehat{\pi}_i$ | $L(\widehat{\pi}_i | y_1, ..., y_5)$ |
| :---: | :---: |
| 0 | 0 |
| 0.05 | 0.002 |
| 0.10 | 0.007 |
...
4. Using your probability estimates from Exercise 3, calculate the likelihood $L(\widehat{\beta}_0, \widehat{\beta}_1 | y_1,...,y_5) = P(y_1,...,y_5 | \widehat{\beta}_0, \widehat{\beta}_1)$.
