...
**Answer:** a linear function takes values between $-\infty$ and $\infty$, so we the left hand side to also take values between $-\infty$ and $\infty$
