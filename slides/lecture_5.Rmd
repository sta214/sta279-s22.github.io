...
.large[
**Definition:** The *likelihood* $L(Model | Data) = P(Data | Model)$ of a model is the probability of the observed data, given that we assume a certain model and certain values for the parameters that define that model.
]
...
* Likelihood: $L(\widehat{\pi}_i | y_1,...,y_5) = P(y_1,...y_5 | \pi_i = 0.9) = 0.00009$
]
...
.large[
\begin{align}
L(0.2 | y_1,...,y_5) &= P(y_1,...,y_5 | \pi_i = 0.2) \\
&= (0.2)(0.8)(0.8)(0.2)(0.8) = 0.020
\end{align}

\begin{align}
L(0.3 | y_1,...,y_5) &= P(y_1,...,y_5 | \pi_i = 0.3) \\ &= (0.3)(0.7)(0.7)(0.3)(0.7) = 0.031
\end{align}
...
.large[
$L(\widehat{\beta}_0, \widehat{\beta}_1 | y_1,...,y_5) =$
...
* $L(\widehat{\beta}_0, \widehat{\beta}_1 | y_1,...,y_n) = P(y_1,...,y_n | \widehat{\beta}_0, \widehat{\beta}_1)$
    
**Maximize:** 
* Choose $\widehat{\beta}_0$, $\widehat{\beta}_1$ to maximize $L(\widehat{\beta}_0, \widehat{\beta}_1 | y_1,...,y_n)$
]
