...
.large[
.center[
$Y_i \sim Bernoulli(\pi_i) \hspace{0.5cm} \left( \dfrac{\pi_i}{1 - \pi_i} \right) = \beta_0 + \beta_1 X_i$
]
]
...
.large[
* Because we have to parameters, $\beta_0$ and $\beta_1$, the situation is more difficult
