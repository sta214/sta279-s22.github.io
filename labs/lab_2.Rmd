...
A template R Markdown file is provided: [lab_02_template.Rmd](https://sta279-s22.github.io/labs/lab_02_template.Rmd)
...
Does the data set have any missing data? If so, remove the missing data and state how many rows you are now left with.
...
Create the empirical logit plot by completing the code below: 
...
* Differentiate the log likelihood in question 13
